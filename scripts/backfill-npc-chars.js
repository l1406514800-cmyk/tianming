...
var FILL_CHAR_NAMES = {
  ...
  '葡萄牙·澳门':     ['Don Lopo Sarmento de Carvalho (理事官)', 'Aleixo Cellos (主教)', 'João Soares (商团长)', 'Pedro Marcondes (船队司令)'],
  '荷兰·台海(东印度公司)': ['Pieter de Carpentier (台湾长官)', 'Hans Putmans (副长官)', 'Cornelis Reijersen (舰队司令)', 'Maarten Sonck (商务议员)'],
  '西班牙·马尼拉':   ['Juan Niño de Tabora (总督)', 'Juan Cevicos (主教)', 'Diego de Quiroga (商团长)', 'Pedro de Heredia (舰队司令)'],
