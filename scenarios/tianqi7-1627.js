  ...
  function buildCharacters() {
    return [
      ...
      // 注：魏忠贤已在上方以完整档案存在（lines 6583+·含 career/familyMembers/_memory 丰富字段），此处不重复。
      {
        ...
        loyalty: 15, ambition: 40, intelligence: 60, administration: 55, integrity: 10,
        stance: '阉党', faction: '明朝廷', family: '王氏', location: '京师·紫禁城',
        traits: ['craven', 'deceitful'],
        isHistorical: true,
        bio: '司礼监掌印太监。按制本在秉笔之上，乃甘自屈居魏忠贤之下，批红皆候其意。日后或可元年斥逐南京。',
        resources: { privateWealth: { cash: 120000, grain: 3000, cloth: 800 } },
      },
      {
        name: '张瑞图', title: '武英殿大学士·礼部尚书', officialTitle: '武英殿大学士', alive: true,
        age: 57, gender: '男', personality: '圆通·工书·趋附', party: '阉党',
        loyalty: 30, ambition: 55, intelligence: 85, administration: 65, integrity: 28,
        stance: '阉党阁臣', faction: '明朝廷', family: '张氏', location: '京师·文渊阁',
        traits: ['studious', 'gregarious', 'deceitful'],
        isHistorical: true,
        bio: '福建晋江人。万历三十五年进士·探花。书法独步海内·草书古劲。以礼部尚书兼武英殿大学士入阁。阉党后进，为魏忠贤生祠题字。日后或可元年削籍戍边·放归。',
        resources: { privateWealth: { cash: 85000, grain: 1800, cloth: 550 } },
      },
      {
        name: '李国普', title: '东阁大学士·礼部右侍郎', officialTitle: '东阁大学士', alive: true,
        age: 53, gender: '男', personality: '持正·方严·耿介', party: '',
        loyalty: 78, ambition: 35, intelligence: 76, administration: 72, benevolence: 70, integrity: 85,
        stance: '中立·清流', faction: '明朝廷', family: '李氏', location: '京师·文渊阁',
        traits: ['honest', 'just', 'patient'],
        isHistorical: true,
        bio: '北直隶高邑人。万历三十五年进士。天启七年以推恩入阁为东阁大学士。虽为阉党所推，而立身持正，不附权阉。魏忠贤所恶。日后或可元年大用为首辅·参劾阉党有力·三年致仕。',
        resources: { privateWealth: { cash: 35000, grain: 1000, cloth: 300 } },
      },
      {
        name: '周应秋', title: '吏部尚书', officialTitle: '吏部尚书', alive: true,
        age: 62, gender: '男', personality: '贪鄙·机巧·奉迎', party: '阉党',
        loyalty: 25, ambition: 70, intelligence: 60, administration: 55, integrity: 15,
        stance: '阉党', faction: '明朝廷', family: '周氏', location: '京师',
        traits: ['deceitful', 'greedy', 'gregarious'],
        isHistorical: true,
        bio: '南直隶金坛人。万历二十三年进士。天启阉党吏部尚书，号「煨蹄总宪」——以煨蹄筋款待魏良卿得宠。黜东林贤能，用阉党群奸。日后或可元年罪遣·论赃抵死。',
        resources: { privateWealth: { cash: 150000, grain: 3000, cloth: 800 } },
      },
      {
        name: '来宗道', title: '礼部尚书', officialTitle: '礼部尚书', alive: true,
        age: 62, gender: '男', personality: '圆滑·媚附·善诗', party: '阉党',
        loyalty: 35, ambition: 40, intelligence: 62, administration: 55, integrity: 25,
        stance: '阉党', faction: '明朝廷', family: '来氏', location: '京师',
        traits: ['deceitful', 'shy', 'studious'],
        isHistorical: true,
        bio: '浙江萧山人。万历三十二年进士。礼部尚书·阉党。善为魏忠贤撰颂文、上尊号。日后或可元年罢归。',
        resources: { privateWealth: { cash: 85000, grain: 1800, cloth: 550 } },
      },
      {
        name: '薛贞', title: '刑部尚书', officialTitle: '刑部尚书', alive: true,
        age: 58, gender: '男', personality: '酷厉·迎附·按狱', party: '阉党',
        loyalty: 15, ambition: 50, intelligence: 55, administration: 50, integrity: 10,
        stance: '阉党酷吏', faction: '明朝廷', family: '薛氏', location: '京师',
        traits: ['cruel', 'deceitful'],
        isHistorical: true,
        _memory: [
          { event: '天启四年掌刑部·杨涟、左光斗、魏大中、袁化中、周朝瑞、顾大章「东林六君子」死于诏狱', emotion: '冷', weight: 10, turn: -1100 }
        ],
        bio: '河南蕲州人。万历三十二年进士。刑部尚书。掌诏狱，致东林六君子狱毙。阉党酷吏。日后或可元年论死·斩于市。',
        resources: { privateWealth: { cash: 85000, grain: 1800, cloth: 550 } },
      },
      {
        name: '薛凤翔', title: '工部尚书', officialTitle: '工部尚书', alive: true,
        age: 60, gender: '男', personality: '阿谀·督造·贪利', party: '阉党',
        loyalty: 30, ambition: 40, intelligence: 55, administration: 58, integrity: 18,
        stance: '阉党', faction: '明朝廷', family: '薛氏', location: '京师',
        traits: ['deceitful', 'gregarious', 'greedy'],
        isHistorical: true,
        bio: '安徽亳州人。万历二十三年进士。工部尚书·阉党。督建魏忠贤生祠遍天下，所费不訾。日后或可元年罢归。',
        resources: { privateWealth: { cash: 85000, grain: 1800, cloth: 550 } },
      },
      {
        name: '李养正', title: '左都御史', officialTitle: '左都御史', alive: true,
        age: 60, gender: '男', personality: '迎附·纠察·不直', party: '阉党',
        loyalty: 25, ambition: 45, intelligence: 55, administration: 50, integrity: 15,
        stance: '阉党都御史', faction: '明朝廷', family: '李氏', location: '京师',
        traits: ['deceitful'],
        isHistorical: true,
        bio: '河南南乐人。左都御史·阉党。风宪大权皆秉魏忠贤之意，黜斥东林。日后或可元年罢归。',
        resources: { privateWealth: { cash: 85000, grain: 1800, cloth: 550 } },
      },
      {
        name: '杨所修', title: '通政使·礼科都给事中', officialTitle: '通政使兼礼科都给事中', alive: true,
        age: 52, gender: '男', personality: '躁进·攻讦·变节', party: '阉党',
        loyalty: 25, ambition: 60, intelligence: 60, administration: 50, integrity: 15,
        stance: '阉党言官', faction: '明朝廷', family: '杨氏', location: '京师',
        traits: ['ambitious', 'deceitful', 'impatient'],
        isHistorical: true,
        bio: '河南商城人。通政使兼礼科都给事中。阉党弹劾东林之急先锋。天启末见机欲变节·倒戈参劾崔呈秀。日后或可元年首鼠两端·终仍罢。',
        resources: { privateWealth: { cash: 35000, grain: 1000, cloth: 300 } },
      },
      {
        name: '涂文辅', title: '提督太监·御马监掌印·秉笔', officialTitle: '秉笔太监·御马监掌印', alive: true,
        age: 55, gender: '男', personality: '残酷·贪婪·掌兵', party: '阉党',
        loyalty: 20, ambition: 50, intelligence: 50, military: 45, integrity: 10,
        stance: '阉党宦官', faction: '明朝廷', family: '涂氏', location: '京师·紫禁城',
        traits: ['cruel', 'greedy'],
        isHistorical: true,
        bio: '御马监掌印太监兼秉笔。阉党酷宦·掌内操军。日后或可元年伏诛。',
        resources: { privateWealth: { cash: 100000, grain: 2500, cloth: 700 } },
      },
      {
        name: '李永贞', title: '秉笔太监·东厂掌刑', officialTitle: '秉笔太监·东厂掌刑', alive: true,
        age: 55, gender: '男', personality: '阴刻·文墨·善构陷', party: '阉党',
        loyalty: 20, ambition: 60, intelligence: 65, administration: 60, integrity: 10,
        stance: '阉党宦官', faction: '明朝廷', family: '李氏', location: '京师·紫禁城',
        traits: ['cruel', 'deceitful', 'studious'],
        isHistorical: true,
        bio: '秉笔太监·东厂掌刑。阉党之刀笔。熟文书·为魏忠贤起草参劾东林诸疏·摘钩逾百人。日后或可元年伏诛。',
        resources: { privateWealth: { cash: 120000, grain: 3000, cloth: 800 } },
      },
      {
        name: '毛一鹭', title: '应天巡抚', officialTitle: '应天巡抚·都察院右副都御史', alive: true,
        age: 50, gender: '男', personality: '畏祸·迎附·奏祠', party: '阉党',
        loyalty: 25, ambition: 65, intelligence: 60, administration: 55, integrity: 10,
        stance: '阉党督抚', faction: '明朝廷', family: '毛氏', location: '南京',
        traits: ['ambitious', 'deceitful', 'craven'],
        isHistorical: true,
        _memory: [
          { event: '天启六年苏州市民五人殴杀缇骑·出钱买五人命平息事态·颜佩韦等五人义葬虎丘', emotion: '惧', weight: 9, turn: -300 }
        ],
        bio: '浙江遂安人。万历三十二年进士。应天巡抚。阉党，奏建魏忠贤生祠于苏州，激起苏州市民五人殉难案(天启六年)。日后或可元年论戍。',
        resources: { privateWealth: { cash: 85000, grain: 1800, cloth: 550 } },
      },
      {
        name: '潘汝桢', title: '浙江巡抚', officialTitle: '浙江巡抚·都察院右副都御史', alive: true,
        age: 58, gender: '男', personality: '巧佞·率先·阿意', party: '阉党',
        loyalty: 25, ambition: 55, intelligence: 55, administration: 52, integrity: 12,
        stance: '阉党督抚', faction: '明朝廷', family: '潘氏', location: '杭州',
        traits: ['deceitful', 'ambitious'],
        isHistorical: true,
        bio: '浙江巡抚。阉党。天启六年奏请为魏忠贤建生祠于杭州，乃天下建祠之嚆矢，诸抚效之。日后或可元年罢。',
        resources: { privateWealth: { cash: 65000, grain: 1500, cloth: 450 } },
      },
      {
        name: '刘诏', title: '顺天巡抚', officialTitle: '顺天巡抚·都察院右副都御史', alive: true,
        age: 58, gender: '男', personality: '附势·守成·守缺', party: '阉党',
        loyalty: 30, ambition: 45, intelligence: 55, administration: 55, integrity: 18,
        stance: '阉党督抚', faction: '明朝廷', family: '刘氏', location: '顺天府',
        traits: ['deceitful'],
        isHistorical: true,
        bio: '顺天巡抚·阉党。治北直隶·京畿之重。日后或可元年罢归。',
        resources: { privateWealth: { cash: 55000, grain: 1300, cloth: 400 } },
      },
      {
        name: '武之望', title: '三边总督·兵部尚书', officialTitle: '三边总督·兼兵部尚书·太子少保', alive: true,
        age: 72, gender: '男', personality: '老成·医术·持重', party: '',
        loyalty: 60, ambition: 28, intelligence: 72, administration: 68, military: 55, integrity: 62,
        stance: '中立·边臣', faction: '明朝廷', family: '武氏', location: '陕西·固原',
        traits: ['honest', 'patient', 'diligent', 'studious'],
        isHistorical: true,
        bio: '陕西临潼人。万历十七年进士。医学家·著《济阴纲目》十卷传世。天启七年由南京兵部尚书转三边总督，时陕西连岁大旱、流民四起。日后或可元年崇祯二年春因陕西民变不堪·忧惧自杀。',
        resources: { privateWealth: { cash: 50000, grain: 1500, cloth: 500 } },
      },
      {
        name: '胡廷宴', title: '陕西巡抚', officialTitle: '陕西巡抚·都察院右副都御史', alive: true,
        age: 60, gender: '男', personality: '苟安·懈怠·不明', party: '',
        loyalty: 40, ambition: 30, intelligence: 55, administration: 50, military: 35, integrity: 30,
        stance: '边抚·偏阉', faction: '明朝廷', family: '胡氏', location: '西安',
        traits: ['craven', 'patient'],
        isHistorical: true,
        _memory: [
          { event: '天启七年陕西大旱·米价腾贵·流民啸聚·王二起事于澄城', emotion: '惧', weight: 9, turn: -60 }
        ],
        bio: '陕西巡抚。值陕西连年饥旱·镇压流民王二等起义·抚剿失宜。日后或可元年被劾罢·陕西民变自此大兴。',
        resources: { privateWealth: { cash: 45000, grain: 1200, cloth: 400 } },
      },
      {
        name: '林尧俞', title: '国子监祭酒·前礼部尚书', officialTitle: '国子监祭酒', alive: true,
        age: 70, gender: '男', personality: '敦厚·清约·训士', party: '',
        loyalty: 72, ambition: 20, intelligence: 72, administration: 60, integrity: 72,
        stance: '中立·耆旧', faction: '明朝廷', family: '林氏', location: '京师·国子监',
        traits: ['patient', 'content', 'honest'],
        isHistorical: true,
        bio: '福建莆田人。万历十七年进士。历官南京礼部尚书，转国子监祭酒。德望素孚。日后或可元年卒于任上。',
        resources: { privateWealth: { cash: 35000, grain: 1000, cloth: 300 } },
      },
      {
        name: '朱梅', title: '蓟州总兵', officialTitle: '蓟州总兵·都督佥事', alive: true,
        age: 55, gender: '男', personality: '勤谨·守成·武弁', party: '',
        loyalty: 60, ambition: 32, intelligence: 52, administration: 45, military: 65, valor: 60, integrity: 50,
        stance: '边将', faction: '明朝廷', family: '朱氏', location: '蓟州·三屯营',
        traits: ['diligent', 'patient'],
        isHistorical: true,
        bio: '蓟州总兵。镇守京畿东路·节制蓟镇。',
        resources: { privateWealth: { cash: 40000, grain: 1200, cloth: 350 } },
      },
      {
        name: '侯世禄', title: '宣府总兵', officialTitle: '宣府总兵·都督佥事', alive: true,
        age: 52, gender: '男', personality: '勇怯参半·守城·依附', party: '',
        loyalty: 50, ambition: 30, intelligence: 48, administration: 40, military: 62, valor: 55, integrity: 42,
        stance: '边将', faction: '明朝廷', family: '侯氏', location: '宣府',
        traits: ['patient'],
        isHistorical: true,
        bio: '宣府总兵。镇宣府防蒙古虏骑。日后或可己巳之变(崇祯二年)后金入关·宣府先溃·论罪。',
        resources: { privateWealth: { cash: 40000, grain: 1200, cloth: 350 } },
      },
      {
        name: '渠家祯', title: '大同总兵', officialTitle: '大同总兵·都督佥事', alive: true,
        age: 50, gender: '男', personality: '谨守·新任·练兵', party: '',
        loyalty: 55, ambition: 28, intelligence: 50, administration: 42, military: 60, valor: 55, integrity: 48,
        stance: '边将', faction: '明朝廷', family: '渠氏', location: '大同',
        traits: ['patient', 'diligent'],
        isHistorical: true,
        bio: '大同总兵。满桂新去·继任镇大同·与察哈尔林丹汗隔长城对峙。',
        resources: { privateWealth: { cash: 40000, grain: 1200, cloth: 350 } },
      },
      {
        name: '杜文焕', title: '延绥总兵·左都督', officialTitle: '延绥总兵·左都督', alive: true,
        age: 53, gender: '男', personality: '剽悍·好战·刚直', party: '',
        loyalty: 55, ambition: 38, intelligence: 55, administration: 45, military: 68, valor: 72, integrity: 45,
        stance: '边将', faction: '明朝廷', family: '杜氏', location: '延绥·榆林',
        traits: ['valiant', 'impatient'],
        isHistorical: true,
        bio: '延绥总兵。镇西北三边·屡破套虏河套部。祖父杜桐·父杜松(萨尔浒阵亡)·世将也。',
        resources: { privateWealth: { cash: 50000, grain: 1500, cloth: 450 } },
      },
      // ──── 东林党/中立老臣 ────
      {
