    ...
    return {
      ...
      conditional: [
        ...
        // ─── 西北民变·陕西大饥荒开局必触发 ───
        {
          ...
          choices: [
            {
              text: '【A 赈济】开太仓发漕粮·银 80 万两·粮 200 万石入陕',
              desc: '户部太仓仅 85 万两·发 80 万则京师九边饷无着。但救民心·可能阻止民变',
              effect: { '帑廪': -800000, '国库粮': -2000000, '民心': +8, '流民数量': -150000, '陕西民变风险': -40, '辽饷压力': +10 }
            },
            {
              text: '【B 免派】陕西三饷(辽饷+剿饷+练饷)三年全免·漕粮就近赈济',
              desc: '辽东九边军饷将缺口 500 万两·朝廷财政崩溃风险。但陕民得活·起义风险骤降',
              effect: { '帑廪': -300000, '民心': +12, '流民数量': -200000, '陕西民变风险': -55, '辽东防线稳固度': -12, '党争烈度': +6 }
            },
            {
              text: '【C 剿抚并举】命洪承畴参政率兵 3000 剿首恶·副以赈济银 20 万两',
              desc: '清流反对以剿民安·阉党主张严剿。王嘉胤等聚众者若擒杀·暂压但根源未除',
              effect: { '帑廪': -200000, '民心': -3, '流民数量': -60000, '陕西民变风险': -15, '阉党权势值': +2, '东林党复苏进度': -3 }
            },
            {
              text: '【D 严剿】加派陕西剿饷银 30 万两·调秦、晋、豫三镇兵会剿',
              desc: '加派为民变之火上浇油·短期镇压但必激起更大反弹。王二/高迎祥/李自成将相继蜂起',
              effect: { '帑廪': +100000, '民心': -15, '流民数量': +100000, '陕西民变风险': +30, '加派压力': +20 }
            },
            {
              text: '【E 观望】"再察再议"·留中不发',
              desc: '粉饰之臣安心·饥民饿毙·次春必反。历史实况——明廷最初选择即此',
              effect: { '帑廪': 0, '民心': -10, '流民数量': +150000, '陕西民变风险': +50, '皇威': -5, '勤政度': -5 }
            },
            {
              text: '【F 罢胡廷宴·起杨鹤抚陕】问粉饰之罪·另择清廉疆臣专任抚治',
              desc: '胡廷宴免·杨鹤(或洪承畴)抚陕·东林欢悦·需后续银粮接济方成事。延缓但不免民变',
              effect: { '帑廪': -100000, '民心': +5, '流民数量': -40000, '陕西民变风险': -25, '东林党复苏进度': +5, '党争烈度': +3, '吏治': +4 }
            }
          ],
