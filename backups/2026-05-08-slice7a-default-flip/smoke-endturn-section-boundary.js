...
assert(sec2[0] >= 100 && sec2[0] <= 180, 'section 2 marker in ai module near setup bridge, actual L' + sec2[0]);
assert(sec3[0] >= 240 && sec3[0] <= 330, 'section 3 marker in ai module after infra, actual L' + sec3[0]);
...
assert(sec5[0] >= 80 && sec5[0] <= 130, 'section 5 marker in followup module near run head, actual L' + sec5[0]);
...
assert(aiLines.length >= 2600 && aiLines.length <= 2750,
  'tm-endturn-ai.js line count after P7-delta 2600-2750, actual ' + aiLines.length);
...
assert(followupLines.length >= 2200 && followupLines.length <= 2350,
  'tm-endturn-followup.js line count after P7-zeta 2200-2350, actual ' + followupLines.length);
