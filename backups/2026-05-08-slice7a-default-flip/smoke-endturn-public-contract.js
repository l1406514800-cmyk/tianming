...
assert(sec5InFollowup >= 80 && sec5InFollowup <= 130, 'section 5 marker near followup run head, actual L' + sec5InFollowup);
...
assert(aiModuleLines >= 2600 && aiModuleLines <= 2750, 'tm-endturn-ai.js line count 2600-2750, actual ' + aiModuleLines);
...
assert(followupModuleLines.length >= 2200 && followupModuleLines.length <= 2350,
  'tm-endturn-followup.js line count 2200-2350, actual ' + followupModuleLines.length);
