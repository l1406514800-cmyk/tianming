    ...
    },
    {
      ...
      fn: async function(ctx) {
        ...
        if (typeof GM !== 'undefined' && GM._pendingShijiModal && GM._pendingShijiModal.courtDone === false) {
          ...
          try { if (typeof advanceCharTravelByDays === 'function') advanceCharTravelByDays((P.time && P.time.daysPerTurn) || 30); }
          ...
          ctx.deferredSteps.push({
            ...
            fn: async function(_dctx) {
              ...
              if (P.keju && (P.keju.currentExam || P.keju.currentEnke) && typeof advanceKejuByDays === 'function') {
                try { advanceKejuByDays((P.time && P.time.daysPerTurn) || 30); }
      ...
      writes: ['GM.shijiHistory', 'GM.eraName', 'GM._pendingToasts', 'GM._lastFixedExpense', 'ctx.input._renderFinalizeRan']
    }
  ];
